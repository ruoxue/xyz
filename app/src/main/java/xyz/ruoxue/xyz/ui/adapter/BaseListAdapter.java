package xyz.ruoxue.xyz.ui.adapter;
...
// | Copyright (c) 2016 http://baimifan.cn All rights reserved.
// +----------------------------------------------------------------------
// | Author: 李上凡 ruoshuisixue@sina.com  创建时间: 2016/4/12_13:56  包名: xyz.ruoxue.xyz.ui.adapter
// +----------------------------------------------------------------------
public abstract class BaseListAdapter<E> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       convertView=null==convertView? LayoutInflater.from(context).inflate(itemLayoutRes(), parent, false):convertView;
